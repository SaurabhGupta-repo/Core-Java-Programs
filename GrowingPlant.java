...
//// if desiredHeight is less then or equals to upspeed, then it will be reach on same day.
if( desiredHeight <= upSpeed)
    return 1;
    
    
double day= Math.ceil( (double)(desiredHeight - upSpeed ) / (upSpeed-downSpeed)) +1 ;
